...
import { CircleDot, Radar, Search } from "lucide-react";
...
export function DashboardOverview() {
  ...
  return <>
    <section className="overview-grid">
      ...
      <Link href="/radars"><Search /><span>本月搜索额度</span><strong>{usage.data ? `${usage.data.remaining} / ${usage.data.monthly_limit}` : "—"}</strong></Link>
    </section>
