...
describe("DashboardOverview", () => {
  it("shows live radar result and credit counts", async () => {
    ...
    vi.mocked(getUsage).mockResolvedValue({ remaining: 82, monthly_limit: 100, reset_at: "2026-10-01T00:00:00+08:00" });
