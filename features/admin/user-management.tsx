...
import { listAdminUsers, setAdminUserStatus, type AdminUser } from "./api";
...
export function UserManagement() {
  ...
  return <section className="settings-panel"><div className="settings-panel-title"><div><span>用户管理</span><h2>账户状态</h2></div><p>{query.data.length} 个账户</p></div><div className="admin-user-list">{query.data.map((value) => <AdminUserRow key={value.id} value={value} />)}</div></section>;
}
