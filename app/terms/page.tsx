...
const sections = [
  {
    ...
    paragraphs: [
      ...
      "本服务处于公开 Beta 前阶段，功能、额度、支持地区和可用性可能调整。每位用户默认每月 100 次搜索额度、最多 3 个活跃雷达；页面显示的当期规则为准。",
    ],
  },
  {
    title: "账户与第三方凭证",
    paragraphs: [
      ...
      "你必须有权使用所提交的 DeepSeek API Key，并自行承担 DeepSeek 产生的费用及其服务条款约束。请勿提交他人的密钥、生产核心密钥或超出本服务所需权限的凭证。",
    ],
  },
  {
    title: "合理使用",
